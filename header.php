...
<head>
	...
	<link rel="stylesheet" href="<?php echo get_stylesheet_uri() . '?v=3'; ?>" type="text/css" />
	<link rel="stylesheet" href="<?php echo get_template_directory_uri() . '/style-plugins.css?v=3'; ?>" type="text/css" />
